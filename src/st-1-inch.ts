...
export function handleEmergencyExitSet(event: EmergencyExitSetEvent): void {
	let entity = new EmergencyExitSet(event.transaction.hash.concatI32(event.logIndex.toI32()))
...
export function handleFeeReceiverSet(event: FeeReceiverSetEvent): void {
	let entity = new FeeReceiverSet(event.transaction.hash.concatI32(event.logIndex.toI32()))
...
export function handleMaxLossRatioSet(event: MaxLossRatioSetEvent): void {
	let entity = new MaxLossRatioSet(event.transaction.hash.concatI32(event.logIndex.toI32()))
...
export function handleMinLockPeriodRatioSet(event: MinLockPeriodRatioSetEvent): void {
	let entity = new MinLockPeriodRatioSet(event.transaction.hash.concatI32(event.logIndex.toI32()))
	entity.ratio = event.params.ratio
...
export function handlePodAdded(event: PodAddedEvent): void {
	let entity = new PodAdded(event.transaction.hash.concatI32(event.logIndex.toI32()))
...
export function handlePodRemoved(event: PodRemovedEvent): void {
	let entity = new PodRemoved(event.transaction.hash.concatI32(event.logIndex.toI32()))
	entity.account = event.params.account
	entity.pod = event.params.pod
