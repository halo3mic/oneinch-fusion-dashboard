...
export function handlePowerPodApproval(event: PowerPodApprovalEvent): void {
  let entity = new PowerPodApproval(
...
export function handlePowerPodDefaultFarmSet(
  event: PowerPodDefaultFarmSetEvent
): void {
  let entity = new PowerPodDefaultFarmSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodEmergencyExitSet(
  event: PowerPodEmergencyExitSetEvent
): void {
  let entity = new PowerPodEmergencyExitSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodFeeReceiverSet(
  event: PowerPodFeeReceiverSetEvent
): void {
  let entity = new PowerPodFeeReceiverSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodMaxLossRatioSet(
  event: PowerPodMaxLossRatioSetEvent
): void {
  let entity = new PowerPodMaxLossRatioSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodMinLockPeriodRatioSet(
  event: PowerPodMinLockPeriodRatioSetEvent
): void {
  let entity = new PowerPodMinLockPeriodRatioSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.ratio = event.params.ratio
...
export function handlePowerPodOwnershipTransferred(
  event: PowerPodOwnershipTransferredEvent
): void {
  let entity = new PowerPodOwnershipTransferred(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodPodAdded(event: PowerPodPodAddedEvent): void {
  let entity = new PowerPodPodAdded(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
...
export function handlePowerPodPodRemoved(event: PowerPodPodRemovedEvent): void {
  let entity = new PowerPodPodRemoved(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.account = event.params.account
  entity.pod = event.params.pod
...
export function handlePowerPodTransfer(event: PowerPodTransferEvent): void {
  let entity = new PowerPodTransfer(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
